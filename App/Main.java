...
public class Main {
	...
	public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcao) {
                case 1:
                    System.out.println("Opcao selecionada: Emitir cartao titular");
                    emiteTitular();
                    break;
                case 2:
    ...
    public static void emiteTitular() {
        ...
        String validadeSQL = conversorDeDatas(validade);
        System.out.println("Digite o limite do cartão: ");
        String limite = scanner.nextLine();
        double limiteDouble = Double.parseDouble(limite);
        titular = new Titular(nome, documento, numero, validadeSQL, limiteDouble);
    ...
    public static void emiteDep() {
    	Scanner scanner = new Scanner(System.in);
	        ...
	        dep = new Dependente(nome, documento, numero, validadeSQL, titular.getLimite(), titular);
    ...
    public static String conversorDeDatas(String data) {
    	//Exemplo de data inserida pelo usuario
    	//16042025
    	//Como a data deve ficar depois da conversão
    	//2025-04-16
    	//Usa o metodo substring para separar o ano, mes e dia
    	String ano = data.substring(4);
    	String mes = data.substring(2, 4);
    	String dia = data.substring(0, 2);
    	// Reorganiza para o padrao SQL
